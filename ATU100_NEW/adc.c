...
//
// AN0: Reverse power (reflektovana snaga)
// AN1: Forward power (prednja snaga)
//
// ADC konfiguracija (u pic_init.c):
//   ANSELA=0x03 (RA0,RA1 analogni), FVR=4.096V, ADCON1=0xE3 (Fosc/64, FVR ref)
//   1 LSB = 4096mV / 1024 = 4.0 mV tacno
//
// Formula:
//   fwd_mV  = ADC(AN0) * 2.0
...
// ============================================================
// ADC - citanje kanala (10-bit, desno poravnanje)
// ADCON0bits.CHS selektuje kanal, GO/nDONE pokretanje
// ============================================================
