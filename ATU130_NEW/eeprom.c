...
//
// Koristi direktne registre (EEADR, EEDATA, EECON1, EECON2)
...
// Ucitaj kalibraciju iz EEPROM-a u runtime varijable
void cal_load(void) {
...
// Sacuvaj runtime varijable u EEPROM
void cal_save(void) {
...
// Boot inicijalizacija - provjeri magic byte, upiši defaults ako treba
void eeprom_init(void) {
    if (ee_read(EE_MAGIC) != EE_MAGIC_VAL) {
        // EEPROM nije inicijalizovan (novi chip ili obrisan)
        // upiši factory defaults
